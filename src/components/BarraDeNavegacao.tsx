...
export default function BarraDeNavegacao() {
  ...
  const translateY = useRef(new Animated.Value(300)).current; // começa fechado
  ...
  return (
    <View style={style.container}>
      ...
      <View>
        <TouchableOpacity style={style.botao} onPress={() => router.push("/pages/ListaRegistro")}>
      ...
      >
        ...
        <TouchableOpacity style={style.botaoEntrada} onPress={() => router.push("/pages/RegistroEntrada")}>
          <Text style={style.buttonText}>Registrar Entrada</Text>
        </TouchableOpacity>
        <TouchableOpacity style={style.botaoSaida} onPress={() => router.push("/pages/RegistroSaida")}>
